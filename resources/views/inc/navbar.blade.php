    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="/lsapp/public/about">About <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item active">
              ...
              <li class="nav-item active">
                    <a class="nav-link" href="/lsapp/public/home">Dashboard <span class="sr-only">(current)</span></a>
                </li>
            </ul>
